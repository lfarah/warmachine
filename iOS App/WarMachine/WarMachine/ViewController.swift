...
//        element.backgroundColor = UIColor.whiteColor()
        ...
        let imageViewOne = UIImageView(image: imageOne!)
        imageViewOne.frame = CGRect(x: 20, y: 50, width: 100, height: 100)
        element.addSubview(imageViewOne)
...
//        element.addSubview(imageViewTwo)
        ...
        label.x = imageViewOne.x + imageViewOne.w + 30
        ...
        let gifView = UIImageView(x: 0, y: 300, w: ez.screenWidth, h: 300, image: myGif!)
